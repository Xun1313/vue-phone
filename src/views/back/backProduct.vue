<template>
  <div mt-5>
    <div class="text-right mt-4">
      <button class="btn btn-primary" @click="openModal('新增')">建立新產品</button>
    </div>
    ...
    <pagination :paginations='pagination' @getProducts='getProducts'></pagination>
...
export default {
  ...
  methods: {
    ...
    deleteModal() {
      ...
      this.$http
        .delete(
          `${process.env.VUE_APP_API}/api/adam/admin/product/${vm.temProduct.id}`
        )
        .then(res => {
          console.log(res);
