      ...
      <div class="swiper-wrapper">
        <div class="swiper-slide">
          ...
          <div class="text" data-swiper-parallax="-100">
            <p>台北三創門市在2015年5月成立於台北市十大建設之一的三創生活園區內，門市經營團隊擁有專業3C商品銷售經驗，秉持著以客為尊及VIP尊爵服務的信念，每一份用心都在期許讓消費者能得到更完善且優質的3C購物環境，店內展示全系列產品，提供顧客完整的體驗，可以安心享受科技為人類帶來的便利。門市人員更重視與顧客的一對一互動，提供最完善的銷售服務！</p>
          </div>
        </div>
        <div class="swiper-slide">
          ...
          <div class="subtitle" data-swiper-parallax="-200">大型專賣店</div>
          <div class="text" data-swiper-parallax="-100">
            <p>台中公益大型專賣店在2018年9月份開幕，於台中公益商圈提供專業及在地化服務。門市內有全系列實機展示、VIVE HOME情境體驗區、多元配件及精品周邊、維修站進駐及數位教室等服務。蔡家國際因擁有十多年專業3C商品銷售經驗，每一份的用心都在期許著讓消費者能得到更完善且優質3C購物環境，且可以安心享受科技為人們帶來的便利。</p>
          </div>
        </div>
        <div class="swiper-slide">
          ...
          <div class="subtitle" data-swiper-parallax="-200">大型專賣店</div>
          <div class="text" data-swiper-parallax="-100">
            <p>高雄大型專賣店坐落於南台灣3C指標商圈之建國商圈，秉持南台灣的熱情我們提供喜歡的朋友一起來交流分享使用經驗與體驗多元服務。蔡家國際因擁有十多年專業3C商品銷售經驗，每一份的用心都在期許著讓消費者能得到更完善且優質3C購物環境，且可以安心享受科技為人類帶來的便利。</p>
          </div>
        </div>
      </div>
      <!-- Add Pagination -->
          ...
          <div class="accordion" id="accordionExample">
              ...
              >
                <div class="card-body">
                  ...
                  <p>
                    ...
                    <br>(02)23513290 分機2151
                    <br>週日~週四 11:00~21:30
                    <br>週五~週六及國定假日前夕 11:00~22:00
                  </p>
                  <p>
                    技術諮詢、維修進度專線 : 0809-090166
                    <br>手機請撥 : (02)21626788
                    <br>週一~週六 10:00~19:00
                    <br>
                  </p>
                </div>
              </div>
            ...
            <div class="card bg-secondary">
              <div class="card-header" id="headingTwo">
                <h2 class="mb-0 text-center">
                  <button
                    class="btn btn-outline-white collapsed"
                    type="button"
                    data-toggle="collapse"
